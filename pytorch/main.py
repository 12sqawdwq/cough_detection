...
def train(args):
    ...
    # Paths
    train_indexes_hdf5_path = args.train_indexes_hdf5_path
    eval_bal_indexes_hdf5_path = args.eval_bal_indexes_hdf5_path
    eval_test_indexes_hdf5_path = args.eval_test_indexes_hdf5_path
    workspace = args.workspace
